...
public class InitNumberListBlock extends TranslatorBlock
{
	public InitNumberListBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
