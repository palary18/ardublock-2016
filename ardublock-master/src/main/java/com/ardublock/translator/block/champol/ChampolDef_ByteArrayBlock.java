...
public class ChampolDef_ByteArrayBlock extends TranslatorBlock
{
	public ChampolDef_ByteArrayBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
