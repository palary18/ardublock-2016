...
public class GetGlobalVarNumberListBlock extends TranslatorBlock
{
	protected GetGlobalVarNumberListBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
