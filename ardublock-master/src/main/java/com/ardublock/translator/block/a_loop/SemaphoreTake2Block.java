...
public class SemaphoreTake2Block extends TranslatorBlock
{
	public SemaphoreTake2Block(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
