...
public class GetGlobalVarRealBlock extends TranslatorBlock
{
	protected GetGlobalVarRealBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	{
		String internalVariableName = translator.getRealVariable(label);
		...
		if (internalVariableName == null)
		{
			...
			translator.addRealVariable(label, internalVariableName);
