...
public class SemaphoreHandleBlock extends TranslatorBlock
{
	public SemaphoreHandleBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
